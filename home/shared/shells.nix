...
let
  nixAliases =
    if isDarwin then
      ...
      {
        rs = "sudo nixos-rebuild switch --impure --flake ${homeDir}/home#${builtins.getEnv "HOSTNAME"}";
        rsp = "sudo nixos-rebuild switch --impure --flake ${homeDir}/home#${builtins.getEnv "HOSTNAME"} --profile-name";
        rb = "sudo nixos-rebuild boot --impure --flake ${homeDir}/home#${builtins.getEnv "HOSTNAME"}";
        rbp = "sudo nixos-rebuild boot --impure --flake ${homeDir}/home#${builtins.getEnv "HOSTNAME"} --profile-name";
